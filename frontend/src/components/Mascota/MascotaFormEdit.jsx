...
function MascotaFormEdit({ isEditarOpen, cerrarEditar, mascota, get_mascotas, viviendas }) {
    ...
    const editarMascota = async (e) => {
        ...
        try {
            const res = await api.put(`/api/mascotas/update/${mascota.id_mascota}/`, updated_mascota);
            if (res.status === 200) {
            ...
            <div className="modal-editar-mascota">
                <div className="modal-editar-mascota-content">
                    ...
                    <form onSubmit={editarMascota}>
                        ...
                        <button className="modal-botton" type="submit">Actualizar mascota</button>
                    </form>
                </div>
            </div>
        )
